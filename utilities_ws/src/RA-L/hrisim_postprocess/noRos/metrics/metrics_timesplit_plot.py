...
for tod in TOD:
    ...
    # Plot all metrics
    plot_stacked_bar(success_failure_metrics, "Success-Failure", "%", CATEGORIES,tod=tod.value, outdir=OUTDIR)
    plot_stacked_bar(working_time_metrics, "Task Time", "%", CATEGORIES, tod=tod.value, outdir=OUTDIR)
    plot_stacked_bar(path_metrics, "Path Length", "%", CATEGORIES, tod=tod.value, outdir=OUTDIR)
    plot_stacked_bar(battery_metrics, "Battery Usage", "%", CATEGORIES, tod=tod.value, outdir=OUTDIR)