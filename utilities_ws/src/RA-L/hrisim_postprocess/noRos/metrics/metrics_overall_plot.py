...
for bagname in BAGNAMES:
    ...
    success_failure_metrics[bagname] = {
        "N. Success": {"value": METRICS['overall_success']*100/METRICS['task_count'], 
                       "color": "tab:blue"},
        "N. Failure (People)": {"value": METRICS['overall_failure_people']*100/METRICS['task_count'], 
                                "color": "tab:orange"},
        "N. Failure (Critical Battery)": {"value": METRICS['overall_failure_critical_battery']*100/METRICS['task_count'], 
                                          "color": "tab:red"}
    }
    working_time_metrics[bagname] = {
        "Active Time": {"value": METRICS['overall_time_to_reach_goal']*100/METRICS['overall_task_time'], 
                        "color": "tab:blue"},
        "Stalled Time": {"value": METRICS['overall_stalled_time']*100/METRICS['overall_task_time'], 
                         "color": "tab:orange"},
        "Wasted Time": {"value": METRICS['overall_wasted_time_to_reach_goal']*100/METRICS['overall_task_time'], 
                        "color": "tab:red"},
    }
    path_metrics[bagname] = {
        "Planned Travelled Distance": {"value": METRICS['overall_path_length_only_success']*100/(METRICS['overall_travelled_distance']+METRICS['overall_wasted_travelled_distance']), 
                                       "color": "tab:blue"},
        "Extra Travelled Distance": {"value": (METRICS['overall_travelled_distance'] - METRICS['overall_path_length_only_success'])*100/(METRICS['overall_travelled_distance']+METRICS['overall_wasted_travelled_distance']), 
                                     "color": "tab:orange"},
        "Wasted Travelled Distance": {"value": METRICS['overall_wasted_travelled_distance']*100/(METRICS['overall_travelled_distance']+METRICS['overall_wasted_travelled_distance']), 
                                      "color": "tab:red"},
    }
    battery_metrics[bagname] = {
        "Planned Battery Usage": {"value": METRICS['overall_planned_battery_consumption_only_success']*100/(METRICS['overall_battery_consumption']+METRICS['overall_wasted_battery_consumption']), 
                                  "color": "tab:blue"},
        "Extra Battery Usage": {"value": (METRICS['overall_battery_consumption'] - METRICS['overall_planned_battery_consumption_only_success'])*100/(METRICS['overall_battery_consumption']+METRICS['overall_wasted_battery_consumption']), 
                                "color": "tab:orange"},
        "Wasted Battery Usage": {"value": METRICS['overall_wasted_battery_consumption']*100/(METRICS['overall_battery_consumption']+METRICS['overall_wasted_battery_consumption']), 
                                 "color": "tab:red"},
    }
    ...
    battery_charging_metrics[bagname] = {
        "Battery Level at the Start of Charging": {"value": METRICS['mean_battery_at_start_charging'], 
                                                   "color": "tab:blue"},
    }
    charging_time_metrics[bagname] = {
        "Charging Time": {"value": METRICS['mean_battery_charging_time'], 
                          "color": "tab:blue"},
    }
