...
for ts in root.findall("time"):
    ...
    plt.bar(waypoints, probabilities, color='tab:blue')
    plt.xlabel("Waypoints", fontsize=14)
    plt.ylabel("Probability", fontsize=14)
    plt.title(f"Probability Distribution of Waypoints in TS = {ts.get('name')}", fontsize=14)
